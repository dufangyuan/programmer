...
<el-form ref="form" :model="formaa" :rules="rules"  label-width="80px" class="kuang">
    <div class="title">
        <h2>登录</h2>
    </div>
  <div class="fu">
  ...
  <el-form-item label="密码:" class="mima" prop="pass">
    <el-input v-model="formaa.password" placeholder="请输入密码" type="password"></el-input>
  </el-form-item>
  <div class="wangji">
  ...
  <div class="jingji">
     我们是<img :src="abc" style="width:25px; height:20px;">程序员的经纪人
  </div>
  </div>
</el-form>
  </el-main>
